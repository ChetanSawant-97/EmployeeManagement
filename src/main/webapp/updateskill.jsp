				...
				<div class="card mt-4">
					...
					<div class="form-row">
							<div class="form-group col-lg-12">
								<label for="inputPassword4">Employee ID</label> <input
						...
						<div class="input-group date">
							<label for="birthday">Birthday : </label> <input class="offset-1" type="date" id="birthday" name="birthday">
						</div>
							...
							<c:forEach items="${skills}" var="s">
								<div class="form-check form-check-inline">
									<input class="form-check-input" type="checkbox" name="skill"
										value="${s.name}"> <label class="form-check-label"
